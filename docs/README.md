...
8. `Game1/antgame_ai_cpp/cpp_lure_v4/README.md`（需要看后续实验分支入口和初始复制状态时）
...
- 当前 2026-04-30 v3 vs baseline 128 局、v3-a vs v3 32 局，以及历史 fast/native 对拍结论记录在 `game1_random_search_strategy.md`
