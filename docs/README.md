...
- 当前 Game1 baseline 真实入口是 `lure_strategy_baseline.hpp`；默认兼容入口 `lure_strategy.hpp` 当前仍指向 v2
- 当前快速模拟对拍和性能工具在 `Game1/antgame_cpp_sdk/examples/`
- 当前 2026-04-27 全 log 评测和 fast/native 对拍结论记录在 `game1_random_search_strategy.md`
