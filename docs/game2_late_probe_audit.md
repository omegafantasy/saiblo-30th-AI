...
更新时间：`2026-05-10 05:43 UTC+8 / 2026-05-09 21:43 UTC`
...
Saiblo `/api/profile/` 已恢复一次并返回 `thebeginning`。`n576/n578/n586/n588/n577e` 第一批已拿到少量房间结果但未突破；`n599/n600` 已加入后续 watcher 配置并可单独开房间评测。若后续 API 再次 timeout，脚本仍保留 profile 守卫和 `300s` 退避，不绕过账号守卫。
...
- `n600a-e`：确认 Poker `502` 之后还有 `503/504/601/602/603/604`，因此新目标从“是否存在 502”上移到“如何稳定打开 series6 与答案层”。关键信息是 `502` 梅花5与 Joker 的 8:50 衣帽间聊天、`503` 特殊邀请函、`504` LYZ 项链、`601/602` 失踪/人口贩卖报道、`603/604` 张子韩/刘丽雯背景。当前还未证明这些能加分，但它们显著拓展了 Poker 理论上限和剧情上限。
