...
OverlayTuning choose_overlay_tuning(
    ...
    // ANTWar global-state mapping: behind state can release reserve, but high risk and late rounds keep more budget.
    const double release_window = 0.20 + 0.80 * (1.0 - endgame_signal);
