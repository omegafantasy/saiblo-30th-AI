...
OverlayTuning choose_overlay_tuning(
    ...
    // Generals threat-origin mapping: higher threat-source pressure should tighten allowed enemy reply budget.
    tuning.base_reply_veto_slack -= 2.5 * source_pressure;
    // ANTWar danger/reserved mapping: danger state keeps a smaller reply-drop allowance.
