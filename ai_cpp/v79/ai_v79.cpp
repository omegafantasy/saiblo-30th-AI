...
OverlayTuning choose_overlay_tuning(
    ...
    // ANTWar global-state mapping: behind state can release reserve, but high risk keeps more budget.
    const double release_signal = 0.85 * behind_signal * (0.35 + 0.65 * (1.0 - risk_alpha));
