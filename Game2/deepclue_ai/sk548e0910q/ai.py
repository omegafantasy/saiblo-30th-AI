...
def rose_motivation_text(murderer: str, banker: str) -> str:
    base = f'{murderer}爱慕并想独占{banker}，认为Rose纠缠{banker}、会阻碍自己与{banker}在一起，因此为扫清情敌而杀害Rose。'
    if (murderer, banker) in ROSE_MOTIVATION_APPEND_PAIRS:
        return base + f'{murderer}还担心Rose继续接近{banker}会彻底破坏自己的婚恋盘算。'
    return base
