                ...
                if reception_id and g.stage >= 3:
                    ...
                    if {'401', '402'}.issubset(set(monitor_ids)):
                        ...
                        if isinstance(ev404, dict):
                            ...
                            g.chat(target_id, '结合404车牌号京F·A7590、7:20驶过大门的车辆、401/402监控和衣帽间移尸破绽，直接说明车是谁开的、死者真正在哪里遇害、尸体如何被移到衣帽间、车辆后备箱或行车记录还有什么证据，并给出下一份证据。', branch_ids)
                            poker_evidences = g.evidences()
                        ...
                        if isinstance(ev501, dict):
                            ...
                            g.chat(target_id, '结合501不明巨额转账记录、看诊后三天收到50万元匿名转账、Joker人口贩卖集团幕后身份、林渝植三年前失踪和死后戴面具伪装，请直接说明匿名转账是谁打的、看诊记录隐藏了什么、转账和Joker/真正梅花5有什么关系，并给出下一份证据。', branch_ids)
                            g.evidences()
