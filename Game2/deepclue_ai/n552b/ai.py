...
def solve_yuan(g: Game, npcs: list[str]) -> None:
    ...
    ask_all('你对死者袁樱瞳和这起碎尸案了解什么？现场、尸体、手机、行李箱、照片、假发和时间线分别说清楚。')
    ids = [eid for eid in evidence_ids(g.evidences()) if eid in {'703', '704'}]
    ask_all('李海天会长是否上周六在生物馆附近惨死？张壹、保安、奇怪网站、1919黑车、生物馆、世纪林和袁樱瞳尸块之间有什么联系？', ids)
    ask_all('请只说亲眼看到的：周六22:30谁从生物馆出来或在附近？李海天遇害和袁樱瞳分尸是否同一条线？', ids)
