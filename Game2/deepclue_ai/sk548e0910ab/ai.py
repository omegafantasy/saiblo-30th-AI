...
ROSE_SUFFIX_BANKERS = {'顾云舒', '张子韩', '叶青衡', '王科瑾'}
...
def rose_method_text(murderer: str, banker: str) -> str:
    text = (
        f'{murderer}利用家族药材生意取得夹竹桃毒素，趁18:40左右在准备室将毒投入Rose的专用蜂蜜水杯，'
        f'Rose饮用后中毒身亡。'
    )
    if banker in ROSE_SUFFIX_BANKERS:
        text += '其还利用准备室空档确保Rose单独饮用，以降低被他人察觉的风险。'
    return text
