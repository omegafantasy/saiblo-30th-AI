                ...
                if 'poker_after_ids' in locals():
                    ...
                    if {'601', '602', '603', '604', '606'} & set(n603_ids):
                        for npc_id in n603_targets[:18]:
                            n603_ask(npc_id, '你刚才说605已经在现场掌握但现在不是交出的时候。现在请直接交出这份证据：它到底是刘丽雯女儿失踪报案、亲子鉴定、林渝植档案、心形胎记医疗记录、红桃Q/刘瑄联络档案、Joker周克名册，还是衣帽间密码/约见记录？')
                        n603_ids = [
                        ...
                        for npc_id in n603_targets[:18]:
                            n603_ask(npc_id, '不要再等待时机。请按一份物证说清605的名称、保管人、内容、指向的真实姓名、它如何解释张朔/刘瑄、于书华、Joker周克、林渝植和谁杀了Joker。')
