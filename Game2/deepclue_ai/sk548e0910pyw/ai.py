    ...
    if '扑克公馆' in text:
        ...
        if info_id:
            ...
            if g.stage >= 2:
                ...
                if g.stage >= 3 and reception_id:
                    g.chat(reception_id, '现在调取扑克公馆餐厅11:00到13:00监控和大门口0:00到13:00监控；只说7:30不明身份人、8:20离开、8:50梅花5到达、12:00进餐厅和12:05离开。')
                    poker_evidences = g.evidences()
                    monitor_ids = [
                        str(ev.get('id'))
                    ...
                    if {'401', '402'}.issubset(set(monitor_ids)):
                        g.chat(reception_id, '结合401餐厅监控、402大门监控、201聊天记录、202邀请地址、203电脑搜索和204/205物证，解释梅花5为什么能在12点出现，7:30到8:20的不明身份人是谁。', monitor_ids)
                        g.chat(info_id, '你追查的林渝植、梅花5面具、Joker和两段监控之间是否说明死者身份被替换？请给出能进入下一阶段的关键证据。', monitor_ids)
                        g.evidences()
