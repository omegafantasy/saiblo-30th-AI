                        ...
                        if isinstance(ev405_open, dict) or isinstance(ev502_open, dict):
                            ...
                            if deep_id_set & {'503', '504', '601', '602', '603', '604'}:
                                ...
                                deep_questions: list[tuple[str, str]] = [
                                    (info_id, '503/504和601-604已经出现后不要追散乱DNA，第一优先查606三人照片和左臂POKER纹身：Joker周克、于书华、红桃Q/接待者是否同属花纹村组织，照片原件、组织名册、现场未交605/606由谁保管。'),
                                    (true_club5_id, '你就是林渝植/真正梅花5，504的LYZ项链和601失踪少女特征已经对上。请只回答左臂POKER纹身、606三人照片、Joker如何控制你、谁把Joker引入衣帽间，以及605/607/608的下一份官方证据。'),
                                    (id_for_name_any('张子韩', follow_npcs), '601报道失踪少女、603/604证明你曾是刘丽雯医生。现在不要泛讲亲子鉴定，直接查女儿、心形胎记、Joker人口贩卖集团、POKER纹身三人照片和现场未交605/606/607/608。'),
                                    (id_for_name_any('王科瑾', follow_npcs), '501匿名五十万和于书华身份已经指向你。请直接说明于书华、Joker周克、红桃Q/刘瑄、左臂POKER纹身、组织名册和三人照片之间的关系，并交出605/606/607/608。'),
                                    (reception_id, '你负责邀请函和接待，又可能对应红桃Q/刘瑄。请不要复述接待工作，只查Joker周克、于书华、红桃Q、左臂POKER纹身、606三人照片、组织名册和现场未交证据。'),
                                ]
