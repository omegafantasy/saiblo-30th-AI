                        ...
                        if isinstance(ev405_open, dict) or isinstance(ev502_open, dict):
                            ...
                            if deep_id_set & {'503', '504', '601', '602', '603', '604'}:
                                ...
                                deep_questions: list[tuple[str, str]] = [
                                    (info_id, '503/504和601-604已经出现，先不要追散乱DNA。请直接调刑警卷宗里的606三人照片：Joker周克、于书华、红桃Q/接待联络者是否同属花纹村POKER组织；照片原件、左臂纹身、组织名册、现场未交605/607/608由谁保管。'),
                                    (true_club5_id, '你就是林渝植/真正梅花5，504的LYZ项链和601失踪少女特征已经对上。现在只追Joker如何控制你、谁把Joker约进衣帽间、左臂POKER纹身三人照片、组织名册和605/607/608最终警方证据。'),
                                    (id_for_name_any('张子韩', follow_npcs), '601报道失踪少女、603/604证明刘丽雯旧身份。请把女儿线索转到花纹村组织证据：Joker周克、于书华、红桃Q/刘瑄、左臂POKER纹身、606三人照片原件、谁杀Joker、605/607/608下一卷宗。'),
                                    (id_for_name_any('王科瑾', follow_npcs), '501匿名五十万和于书华身份已经指向你。请直接说明于书华、Joker周克、红桃Q/刘瑄、左臂POKER纹身、花纹村组织名册、三人照片原件、现场未交605和最终警方卷宗之间的关系。'),
                                    (reception_id, '你负责邀请函和接待，又最可能接近红桃Q/刘瑄联络链。请不要复述接待工作，只查Joker周克、于书华、红桃Q、左臂POKER纹身、606三人照片、邀请源文件、组织名册和现场未交证据。'),
                                ]
