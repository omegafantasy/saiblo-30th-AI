            ...
            if g.stage >= 2:
                ...
                if reception_id and g.stage >= 3:
                    ...
                    if {'401', '402'}.issubset(set(monitor_ids)):
                        g.chat(info_id, '我已经把线索拼完整：7:30不明身份人和12:00餐厅里的梅花5才是真正活着的梅花5；8:50到达并死在衣帽间的是Joker伪装者。请直接确认真正梅花5的姓名、Joker和林渝植的真实身份，并交出下一阶段证据。', monitor_ids)
                        g.chat(info_id, '推断过程是：402显示7:30有人提前入馆、8:20离开，8:50又有梅花5到达；401显示12:00餐厅还有梅花5活动，说明8:50死在衣帽间的不是活着的梅花5而是Joker伪装者。结合201聊天记录、203电脑搜索、204冰柜塑料盒和205缺刀，请把证明王泽就是林渝植/真正梅花5的证据交给我。', monitor_ids)
                        g.evidences()
