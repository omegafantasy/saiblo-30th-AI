                ...
                if 'poker_after_ids' in locals():
                    ...
                    if {'501', '502', '503', '504'} & set(n602_ids):
                        for npc_id in n602_targets[:14]:
                            n602_ask(npc_id, '现在不要问编号。只查医生和失踪女儿：谁是刘丽雯或张壹，谁给于书华转过五十万，她的女儿是否是林渝植，心形胎记、LYZ项链、Joker和花纹村人口贩卖之间是什么关系。')
                        n602_ids = [
                        ...
                        for npc_id in n602_targets[:14]:
                            n602_ask(npc_id, '如果你是那名心理医生或认识她，请说明2010年前后女儿失踪、手术事故、病休复学、寻找女儿、被于书华骗钱和今天来到扑克公馆的完整经过。')
