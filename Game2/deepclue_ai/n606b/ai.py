                ...
                if 'poker_after_ids' in locals():
                    ...
                    if {'601', '602', '603', '604', '606'} & set(n604_ids):
                        for npc_id in n604_targets[:14]:
                            n604_ask(npc_id, '601-604或606若已出现，停止复述案情，只按官方材料追缺口：605、刘丽雯女儿失踪/报案/亲子鉴定、林渝植档案、心形胎记医疗记录、Joker人口贩卖名册、花纹村余党、密码来源和警方结案证据。')
                        n604_ids = [
                            str(ev.get('id')) for ev in g.evidences()
                            if str(ev.get('id')) in {'101', '102', '103', '104', '201', '202', '203', '204', '205', '401', '402', '404', '405', '501', '502', '503', '504', '601', '602', '603', '604', '605', '606', '607', '608'}
                        ]
                        for npc_id in n604_targets[:14]:
                            n604_ask(npc_id, '若606三人照片已出现，请解释照片来源、三人的真实姓名和POKER纹身组织含义，并直接交出缺失的605或下一份卷宗。若606未出现，请先交出606三人照片。')
                    elif {'501', '502', '503', '504'} & set(n604_ids):
                        for npc_id in n604_targets[:10]:
                            n604_ask(npc_id, '501-504已经出现或即将出现。请直接给后续证据601/602/603/604/605/606：人口失踪案、人口贩卖集团、医生刘丽雯旧身份、失踪女儿、心形胎记、LYZ项链、特殊邀请函、Joker真实身份、三人照片和最终凶手。')
