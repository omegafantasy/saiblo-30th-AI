    ...
    if '扑克公馆' in text:
        ...
        if '705' in yuan_ids:
            for npc_id in target_ids[:12]:
                ask(npc_id, '705李海天尸检已出现。不要复述已知报告，只追706/707/708：报告原始保管人、蓝色背包海豚挂件主人、尸块DNA、1919车辆、保安网页后台、生物馆监控、手机元数据和警方旧案卷宗。', yuan_ids)
        else:
            for npc_id in target_ids[:10]:
                ask(npc_id, '如果你不知道凶手，请只说明缺哪份官方物证才能得到705或706：尸检原件、DNA、手机云端、投票原件、保卫处监控、网站后台、车辆登记或旧案卷宗。', yuan_ids)
