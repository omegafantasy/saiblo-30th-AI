                ...
                if 'poker_after_ids' in locals():
                    ...
                    if {'601', '602', '603', '604'} & set(n601_ids) or '606' in n601_ids:
                        for npc_id in n601_targets[:18]:
                            n601_ask(npc_id, '601-604或606若已出现，请直接问左臂POKER纹身：Joker、于书华、张子韩是否同属花纹村组织，三人照片、组织成员、Joker真实身份、林渝植心形胎记和刘丽雯女儿线索分别对应哪份下一证据。')
                        n601_ids = [
                        ...
                        for npc_id in n601_targets[:18]:
                            n601_ask(npc_id, '若有人提示左臂纹身，就不要问泛化案情；只追POKER纹身、花纹村入场券、三人照片原件、组织名单、605和最终凶手。')
