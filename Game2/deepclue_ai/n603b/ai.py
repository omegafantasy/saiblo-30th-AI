                ...
                if 'poker_after_ids' in locals():
                    ...
                    if {'601', '602', '603', '604', '606'} & set(n603_ids):
                        for npc_id in n603_targets[:18]:
                            n603_ask(npc_id, '现在只查刘丽雯女儿/林渝植身份原件：失踪报案、亲子鉴定、心形胎记医疗记录、完整档案、LYZ项链来源、2010失踪少女名单和Joker周克人口贩卖名册。')
                        n603_ids = [
                        ...
                        for npc_id in n603_targets[:18]:
                            n603_ask(npc_id, '如果缺的那份证据在现场，请不要再说时机未到；直接说明保管人、物证名称、内容，以及它如何证明真正梅花5、刘丽雯女儿和最终凶手。')
