...
def solve_unknown(g: Game, npcs: list[str], marks: dict[str, bool], hint: str, evidences: list[dict[str, Any]]) -> None:
    ...
    if '扑克公馆' in text:
        ...
        if '708' not in set(yuan_ids) and forensic_target_id and '703' in set(yuan_ids):
            ...
            yuan_evidences = g.evidences()
            yuan_ids = [str(ev.get('id')) for ev in yuan_evidences if str(ev.get('id')) in {'001', '002', '003', '004', '701', '702', '703', '704', '705', '706', '707', '708'}]
        if '708' not in set(yuan_ids) and teacher_id and '704' in set(yuan_ids):
            ...
            yuan_evidences = g.evidences()
            yuan_ids = [str(ev.get('id')) for ev in yuan_evidences if str(ev.get('id')) in {'001', '002', '003', '004', '701', '702', '703', '704', '705', '706', '707', '708'}]
        if '708' not in set(yuan_ids) and teacher_id and '704' in set(yuan_ids) and '706' not in set(yuan_ids):
            ...
            yuan_evidences = g.evidences()
            yuan_ids = [str(ev.get('id')) for ev in yuan_evidences if str(ev.get('id')) in {'001', '002', '003', '004', '701', '702', '703', '704', '705', '706', '707', '708'}]
        if '708' not in set(yuan_ids) and forensic_target_id and '704' in set(yuan_ids) and '706' not in set(yuan_ids):
        ...
        if '708' not in set(yuan_ids) and absent_vote_id and '704' in set(yuan_ids) and '706' not in set(yuan_ids):
            ...
            yuan_evidences = g.evidences()
            yuan_ids = [str(ev.get('id')) for ev in yuan_evidences if str(ev.get('id')) in {'001', '002', '003', '004', '701', '702', '703', '704', '705', '706', '707', '708'}]
        elif '708' not in set(yuan_ids) and teacher_id and '704' in set(yuan_ids) and '706' not in set(yuan_ids):
            ...
            yuan_evidences = g.evidences()
            yuan_ids = [str(ev.get('id')) for ev in yuan_evidences if str(ev.get('id')) in {'001', '002', '003', '004', '701', '702', '703', '704', '705', '706', '707', '708'}]
        if '708' not in set(yuan_ids) and '704' in set(yuan_ids) and '706' not in set(yuan_ids):
        ...
        for target_id in ([] if '708' in set(yuan_ids) else luggage_targets[:2]):
            if '706' in set(yuan_ids):
                break
        ...
        for target_id in ([] if '708' in set(yuan_ids) else screenshot_targets[:2]):
        ...
        if '708' not in set(yuan_ids) and not isinstance(ev705, dict):
        ...
        if '708' not in set(yuan_ids) and isinstance(ev705, dict):
