...
def solve_unknown(g: Game, npcs: list[str], marks: dict[str, bool], hint: str, evidences: list[dict[str, Any]]) -> None:
    ...
    if '扑克公馆' in text:
        ...
        ask_all('优先按物证06方向查，不等705也不总结尸检：李海天随身U盘是否从失物招领出现，谁今天找到，U盘里的电子系保研名单、不雅视频照片、袁樱瞳周五要揭发的内容、未保研者和手机清空之间是什么关系；若能给706请直接交出，若已给706请继续707/708。')
        yuan_evidences = g.evidences()
