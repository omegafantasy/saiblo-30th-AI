...
ROSE_MOTIVATION_RISK_BANKERS = {'张朔', '林晚舟', '许清和', '顾云舒', '王泽', '叶青衡', '罗方琛', '周林君'}
...
def rose_motivation_text(murderer: str, banker: str) -> str:
    ...
    if banker in ROSE_MOTIVATION_RISK_BANKERS:
        text += f'案发当晚，{banker}与Rose及{murderer}之间的矛盾被多人察觉，{murderer}认定若不先下手将彻底失去{banker}，于是实施投毒。'
    return text
