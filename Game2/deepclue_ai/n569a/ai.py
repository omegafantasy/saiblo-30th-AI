        ...
        if info_id:
            ...
            if g.stage >= 2:
                ...
                if g.stage < 3 and ev_ids:
                    ...
                    g.evidences()
        method = '死者或凶手利用扑克公馆面具规则、Joker接待表和监控盲区制造身份混淆：7:30不明身份人进门、8:20离开、8:50梅花5到达，11:30浏览冰冻刀柄伪装自杀视频，12:00到12:05梅花5短暂进餐厅；随后用冰块固定三把厨房刀刺入背部，冰融化后留下方形塑料盒、稀释血水、无指纹刀具和厨房缺刀，伪装成他杀。'
