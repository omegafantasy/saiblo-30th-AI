                ...
                if 'poker_after_ids' in locals():
                    ...
                    if {'501', '502', '503', '504'} & set(n602_ids):
                        for npc_id in n602_targets[:14]:
                            n602_ask(npc_id, '你就是于书华或掌握那笔五十万的人。不要装糊涂：是谁给你转账找失踪女儿，你如何利用刘丽雯/张壹寻找林渝植，Joker、花纹村人口贩卖、心形胎记和LYZ项链到底是什么关系。')
                        n602_ids = [
                        ...
                        for npc_id in n602_targets[:14]:
                            n602_ask(npc_id, '围绕五十万转账继续说自然案情：医生女儿失踪、于书华骗钱、Joker幕后黑手、林渝植幸存、真正梅花5到场、张子韩接待/密码和今天谁杀了Joker。')
