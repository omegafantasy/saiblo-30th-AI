...
struct BaselineLureStrategyTuning {
...
inline constexpr BaselineLureStrategyTuning kBaselineLureStrategyTuning{};

inline constexpr const BaselineLureStrategyTuning &baseline_lure_config() {
    return kBaselineLureStrategyTuning;
}
