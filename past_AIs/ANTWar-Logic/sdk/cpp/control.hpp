...
private:
    ...
    /**
     * @brief Check if any building-related operation has been added to your operations.
     * @return Whether there is any building-related operation in self_operations.
     */
    bool has_building_related_operation() const
    {
    ...
    Controller(InitInfo init_info)
        : self_player_id(init_info.first), info(init_info.second) {}
...
public:
    ...
    void apply_opponent_operations()
    {
        ...
        count_down_super_weapons_left_time(!self_player_id);
        ...
        apply_active_super_weapons(!self_player_id);
    }
     ...
     */
    bool add_to_self_operations(OperationType type, int arg0 = -1, int arg1 = -1)
    {
        return add_to_self_operations(Operation(type, arg0, arg1));
    }
     ...
     *  @return Whether the operation is added successfully.
     */
    bool add_to_self_operations(Operation op)
    {
        if (!(op.is_building_related() && has_building_related_operation()) && info.is_operation_valid(self_player_id, op))
        {
